package com.stock.framework.service.impl;
...
import com.stock.framework.util.HSUtil;
import com.stock.framework.util.HttpClientUtil;
import com.stock.framework.util.JacksonUtils;

public class HsStockService implements StockService {
	
	/*private static StockService hsStockService= null;
	
	public static StockService getHsStockService(){
		
		if(null == hsStockService){
			hsStockService = new HsStockService();
		}
		return hsStockService;
	}*/
